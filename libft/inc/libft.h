...
/*   Updated: 2019/05/15 23:20:47 by tkatolik         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	structs ___________________________
*/
...
/*
**	Linked list (Bonus Part) __________
*/
...
/*
**	Own Functions _____________________
*/

char				*ft_imaxtoa_base(intmax_t num, uintmax_t base, int flag);
char				*ft_uimaxtoa_base(uintmax_t num, uintmax_t base, int flag);
char				*ft_ftoa(long double num, int presicion);
char				*ft_ftoe(long double num, int presicion);
char				*ft_ftobige(long double num, int presicion);
...
t_list				ft_lstparamc(int ac, char **av);
